...
if __name__ == "__main__":
    ...
    script_values = ['pyblksim']    
    fs_values = np.logspace(np.log10(1e3), np.log10(1e7), num=10, base=10).astype(int).tolist()
    ...
    for script in script_values:
        ...
        for fs in fs_values:
            ...
            for i in range(n):
                results.append([script, fs, i + 1, exec_times[i], peak_mem_usages[i], avg_mem_usages[i]])
